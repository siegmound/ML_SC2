...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\textwidth]{img/rf_feature_importance.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.48\textwidth]{img/accuracy_vs_duration.png}\hfill
\includegraphics[width=0.48\textwidth]{img/rf_accuracy_vs_duration.png}
