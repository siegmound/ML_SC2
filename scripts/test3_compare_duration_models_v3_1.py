...
MLP_DURATION_PATH = artifact_path("mlp_torch_gpu_v3_1_accuracy_vs_duration.csv")
...
def main():
    ...
    out_csv = artifact_path(f"{OUTPUT_PREFIX}.csv")
    ...
    plt.legend()
    plt.tight_layout()
    plot_path = figure_path(f"{OUTPUT_PREFIX}.png")
    ...
    plt.tight_layout()
    sample_plot_path = figure_path(f"{OUTPUT_PREFIX}_sample_counts.png")
    ...
    summary_path = artifact_path(f"{OUTPUT_PREFIX}_summary.json")
